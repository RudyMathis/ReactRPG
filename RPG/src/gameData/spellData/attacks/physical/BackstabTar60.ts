...
const spellCost = 60;
const damageMulitplier = 2.25;
const BackstabTar60 = (enemy: EnemyType, character: CharacterType, target: CharacterType | EnemyType) =>{ 
    ...
    if(targetCharacter) {
        ...
        const damage =  Math.max(.250, Math.round((character.attack * damageMulitplier) - enemy.defense))
